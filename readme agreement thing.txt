Welcome to the Python 3.19 Windows client version 1.0.2 -- 1.1.0 agreement. Only in the early stages, this client does require some manual work to setup. By running this installer, you are agreeing to the following agreement below:   
